   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid6784", tween: [ "style", "${_cat}", "-moz-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6785", tween: [ "style", "${_cat}", "-ms-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6786", tween: [ "style", "${_cat}", "msTransformOrigin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6787", tween: [ "style", "${_cat}", "-o-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
...
"catAnimation": {
   ...
   {
      rect: ['440px','auto','13.5%','12.8%','auto','110px'],
   ...
   {
      rect: ['auto','auto','13.5%','12.8%','110px','27px'],
      font: ['Arial, Helvetica, sans-serif',24,'rgba(0,0,0,1)','normal','none','normal'],
      align: 'center',
      id: 'b_damage_label',
      text: 'Miss!!',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid5838", tween: [ "style", "${_b_damage_label}", "opacity", '1', { fromValue: '0.000000'}], position: 8750, duration: 250 },
            { id: "eid5857", tween: [ "style", "${_b_damage_label}", "opacity", '1', { fromValue: '0.000000'}], position: 10500, duration: 250 },
            ...
            { id: "eid5860", tween: [ "style", "${_b_damage_label}", "display", 'block', { fromValue: 'none'}], position: 8750, duration: 0, easing: "easeOutBounce" },
            { id: "eid5861", tween: [ "style", "${_b_damage_label}", "display", 'none', { fromValue: 'block'}], position: 9250, duration: 0, easing: "easeOutBounce" },
            { id: "eid5858", tween: [ "style", "${_b_damage_label}", "display", 'block', { fromValue: 'none'}], position: 10500, duration: 0, easing: "easeOutBounce" },
            { id: "eid5859", tween: [ "style", "${_b_damage_label}", "display", 'block', { fromValue: 'block'}], position: 10750, duration: 0, easing: "easeOutBounce" },
            { id: "eid5862", tween: [ "style", "${_b_damage_label}", "display", 'none', { fromValue: 'block'}], position: 11000, duration: 0, easing: "easeOutBounce" },
            { id: "eid5840", tween: [ "style", "${_b_damage_label}", "bottom", '110px', { fromValue: '150px'}], position: 8750, duration: 250, easing: "easeOutBounce" },
            { id: "eid5856", tween: [ "style", "${_b_damage_label}", "bottom", '110px', { fromValue: '150px'}], position: 10500, duration: 250, easing: "easeOutBounce" },
            { id: "eid5910", tween: [ "style", "${_w_damage_label}", "display", 'block', { fromValue: 'none'}], position: 2750, duration: 0, easing: "easeOutBounce" },
            { id: "eid5911", tween: [ "style", "${_w_damage_label}", "display", 'none', { fromValue: 'block'}], position: 3250, duration: 0, easing: "easeOutBounce" },
            { id: "eid5912", tween: [ "style", "${_w_damage_label}", "display", 'block', { fromValue: 'none'}], position: 4500, duration: 0, easing: "easeOutBounce" },
            { id: "eid5913", tween: [ "style", "${_w_damage_label}", "display", 'block', { fromValue: 'block'}], position: 4750, duration: 0, easing: "easeOutBounce" },
            { id: "eid5914", tween: [ "style", "${_w_damage_label}", "display", 'none', { fromValue: 'block'}], position: 5000, duration: 0, easing: "easeOutBounce" },
            ...
            { id: "eid5917", tween: [ "style", "${_w_damage_label}", "bottom", '110px', { fromValue: '150px'}], position: 2750, duration: 250, easing: "easeOutBounce" },
            { id: "eid5918", tween: [ "style", "${_w_damage_label}", "bottom", '110px', { fromValue: '150px'}], position: 4500, duration: 250, easing: "easeOutBounce" },
            { id: "eid5915", tween: [ "style", "${_w_damage_label}", "opacity", '1', { fromValue: '0.000000'}], position: 2750, duration: 250 },
            { id: "eid5916", tween: [ "style", "${_w_damage_label}", "opacity", '1', { fromValue: '0.000000'}], position: 4500, duration: 250 },
...
"whitecatSprite": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            { id: "eid150", tween: [ "style", "${_cat}", "-webkit-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6788", tween: [ "style", "${_cat}", "-moz-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6789", tween: [ "style", "${_cat}", "-ms-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6790", tween: [ "style", "${_cat}", "msTransformOrigin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid6791", tween: [ "style", "${_cat}", "-o-transform-origin", [50,18], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,18]}], position: 4000, duration: 0 },
            { id: "eid10", tween: [ "style", "${_cat}", "clip", [0,80,90,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,80,90,0]}], position: 0, duration: 0 },
            { id: "eid11", tween: [ "style", "${_cat}", "clip", [0,100,90,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,80,503,0]}], position: 1000, duration: 0 },
            { id: "eid13", tween: [ "style", "${_cat}", "clip", [0,100,90,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,100,90,0]}], position: 2000, duration: 0 },
            { id: "eid15", tween: [ "style", "${_cat}", "clip", [0,100,90,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,100,503,0]}], position: 3000, duration: 0 },
